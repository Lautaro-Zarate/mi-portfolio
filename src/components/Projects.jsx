const Projects = () => {
    ...
    return (
        ...
        <div className="project-container">
            <img src="/public/project1.webp" alt="proyecto1" className="project__image"/>
            <div className="project__container-secondary">
                <img src="/public/brand-project1.png" alt="Logo de proyecto 1" className="project__brand"/>
        ...
        <div className="project-container">
        <img src="/public/project2.webp" alt="proyecto2" className="project__image"/>
        <div className="project__container-secondary">
            <img src="/public/brand-project2.png" alt="Logo de proyecto 2" className="project__brand"/>
        ...
        <div className="project-container">
        <img src="/public/project3.webp" alt="proyecto3" className="project__image"/>
        <div className="project__container-secondary">
            <img src="/public/brand-project3.png" alt="Logo de proyecto 3" className="project__brand"/>
